...
public interface WebSocketMessages {
    ...
    @Message(id = 2043, value = "Compressed message payload is corrupted")
    IOException badCompressedPayload();

    @Message(id = 2044, value = "WebSocket client is trying to use extensions but there is not extensions configured")
